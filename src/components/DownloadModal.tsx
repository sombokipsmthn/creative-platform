    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-6 text-white">
      <div className="max-w-md w-full p-8 border border-zinc-800 bg-zinc-950 rounded-2xl space-y-6 shadow-2xl relative">
        ...
        <div className="space-y-1">
          <p className="text-xs font-sans uppercase text-purple-400 tracking-widest">Digital Delivery Engine</p>
        ...
        <form onSubmit={handleDownload} className="space-y-6">
          ...
          {requiresPin && (
            <div className="space-y-2">
              <label className="text-xs text-zinc-400 font-sans">4-Digit Download PIN</label>
              <input
                type="password"
                maxLength={4}
                placeholder="••••"
                ...
                className="w-full text-center text-2xl font-sans tracking-[0.5em] py-2 bg-zinc-900 border border-zinc-700 text-white rounded-lg focus:border-purple-600 focus:outline-none"
              />
            </div>
          )}
          ...
          {/* Selection Choice */}
          <div className="space-y-2">
            <label className="text-xs text-zinc-400 font-sans">Download Scope</label>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => setDownloadType('favorites')}
                className={`p-3 text-xs font-sans rounded-lg border text-left space-y-1 transition-all ${
          ...
          {/* Resolution Choice */}
          <div className="space-y-2">
            <label className="text-xs text-zinc-400 font-sans">Resolution & Format</label>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
          ...
          <button
            ...
            className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white text-xs font-sans uppercase tracking-widest rounded-lg transition-colors shadow-[0_0_20px_rgba(124,58,237,0.3)] disabled:opacity-50"
          >
