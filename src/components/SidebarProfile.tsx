    ...
    <>
      ...
      >
        <div
          ...
          className="flex items-center gap-3 rounded-full outline-none transition focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-950"
        >
          {user.imageUrl ? (
            <Image
              src={user.imageUrl}
          ...
          <button
            className="ml-auto p-1 rounded-hover transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-950"
            onClick={() => setOpen((value) => !value)}
          >
            <svg
              width="14"
            ...
            <div className="p-2">
              ...
              >
                ...
                >
                  <path d="M14 3h7v7" />
                  <path d="M10 14 21 3" />
                  <path d="M21 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1 2-2h5" />
                </svg>
